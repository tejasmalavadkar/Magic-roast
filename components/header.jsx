    ...
    <header className="w-full">
      ...
      <nav className="bg-[#FDEBC8] py-4 px-4 md:px-8 flex items-center justify-between shadow-sm">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/shop" className="text-[#5a3921] font-medium hover:text-[#d4a84b] transition-colors">
            SHOP
          </Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t shadow-lg">
          <div className="flex flex-col p-4 gap-4">
            ...
            <Link href="/shop" className="text-[#5a3921] font-medium py-2 border-b">
              SHOP
            </Link>
            <Link href="/blogs" className="text-[#5a3921] font-medium py-2 border-b">
              BLOGS
            </Link>
            <Link href="/contact" className="text-[#5a3921] font-medium py-2 border-b">
              CONTACT
            </Link>
            
            {/* Mobile Account Options */}
            <div className="pt-4 border-t">
              <Link href="/my-account" className="block text-[#5a3921] font-medium py-2 hover:text-[#d4a84b] transition-colors">
                My Account
              </Link>
              <Link href="/login" className="block text-[#5a3921] font-medium py-2 hover:text-[#d4a84b] transition-colors">
                Login
              </Link>
              <Link href="/register" className="block text-[#5a3921] font-medium py-2 hover:text-[#d4a84b] transition-colors">
                Register
              </Link>
            </div>
          </div>
